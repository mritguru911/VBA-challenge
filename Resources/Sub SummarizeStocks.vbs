Sub SummarizeStocks()
    ...
    Dim StockOpen, StockClose, QuarterlyChange, PercentChange As Double
        ...
        For i = 2 To LastRow
            ...
            Else
                ...
                If StockOpen <> 0 Then
                    ...
                    PercentChange = (QuarterlyChange / StockOpen)
                ...
                '--- if QuarterlyChange is positive, change the cell color to green ---
                If QuarterlyChange >= 0 Then
                    ws.Cells(OutputRow, 10).Interior.ColorIndex = 4
                
                '--- if QuarterlyChange is negative, change cell color to red ---
                Else
